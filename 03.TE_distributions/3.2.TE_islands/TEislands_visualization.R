setwd("/media/wuei/Edisk1/Projects/Barthea/Transposable_elements/03.TE_distributions/TE_islands/500k/TEislands_500k")
install.packages("devtools") 
library(devtools)
devtools::install_github("Bioconductor/BiocManager")
install.packages("BiocManager",lib="/home/wuei/R/x86_64-pc-linux-gnu-library/3.6")
library(BiocManager)
...
groups<-c("Gyspy","Copia","nonLTR","TIR","Helitron","TEislands")
for(i in groups){
...
pf2
dev.print(pdf,"./CobsA2.1.pdf",width=10,height=2.25)
