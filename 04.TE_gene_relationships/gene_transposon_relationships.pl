...
while(<TE>){
         ...
         my $subgenome = "grep -E $chr bar_genome_introns_reduced.gff3 > bar_$chr.gff3";
            system($subgenome);
         ...
         my $case1 = "awk  '{if(\$5<$start){print \$0;}}' bar_$chr.gff3 | tail -n 1 >hit_nonoverlap_downstream";
            system($case1);
         ...
         my $case5 = "awk '{if(\$4>$end){print \$0}}' bar_$chr.gff3|head -n 1 > hit_nonoverlap_upstream";
	       ...
	       ($chr5,$feature5,$start5,$end5,$id5)=(split/[\t;]/,$res5)[0,2,3,4,8];
            ...
            if($d3==0){
               print OUT "$chr\t$feature\t$start\t$end\t$id\t$chr3\t$feature3\t$start3\t$end3\t$id3\t$d3\tNested\n";
            }
              ...
              print OUT "$chr\t$feature\t$start\t$end\t$id\t$chr5\t$feature5\t$start5\t$end5\t$id5\t$d5\tnonoverlap_upstream\n";
            }
